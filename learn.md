...
* Similarly, [order/index.ts](src/postgraphile/order/index.ts) defines `checkout` and allows subscribing to the events of one order (`order`) or the events of all orders visible to the user (`orders`)
